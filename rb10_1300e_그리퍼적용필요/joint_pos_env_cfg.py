...
# Pre-defined configs
##
from omni.isaac.lab_assets.rb10_1300e import RB10_1300e_CFG  # isort: skip


@configclass
class Rb10_1300e_CabinetEnvCfg(CabinetEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        # Set franka as robot
        self.scene.robot = RB10_1300e_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
